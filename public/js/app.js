...
__webpack_require__(/*! ./initMaterialize */ "./resources/js/initMaterialize.js");

var _require = __webpack_require__(/*! ./init */ "./resources/js/init.js"),
    init = _require.init;
...
/*!******************************!*\
  !*** ./resources/js/auth.js ***!
  \******************************/
/*! exports provided: loginHandler, signupHandler, logoutHandler */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "logoutHandler", function() { return logoutHandler; });
...
function signupHandler(password, email) {
  return new Promise(
  /*#__PURE__*/
  function () {
...
function init() {
  ...
  var signupPasswordInput = document.querySelector('.user-password');
  var signupEmailInput = document.querySelector('.user-email');
  ...
  var events = {
    ...
    login: _auth__WEBPACK_IMPORTED_MODULE_0__["loginHandler"],
    logout: _auth__WEBPACK_IMPORTED_MODULE_0__["logoutHandler"],
    redirect: _utils_redirect__WEBPACK_IMPORTED_MODULE_1__["redirect"]
  };
...
/***/ "./resources/js/initMaterialize.js":
/*!*****************************************!*\
  !*** ./resources/js/initMaterialize.js ***!
  \*****************************************/
/*! no static exports found */
...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (dropdownEls) {
      var instances = M.Dropdown.init(dropdownEls, {
        coverTrigger: false,
    ...
    var deleteButton = document.querySelector('.ticket-reply .btn-delete');
...
/***/ "./resources/js/utils/redirect.js":
/*!****************************************!*\
  !*** ./resources/js/utils/redirect.js ***!
  \****************************************/
...
__webpack_require__(/*! /Users/avpaul/code/te-help-desk/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/avpaul/code/te-help-desk/resources/sass/app.scss */"./resources/sass/app.scss");
